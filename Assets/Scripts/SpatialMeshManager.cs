...
namespace Unity.XR.PXR
{
    ...
    public class SpatialMeshManager : MonoBehaviour
    {
        ...
        // INTERNAL DEBUG, lets see if we can add an offset to the mesh
        [SerializeField] public Transform headset_offset;
        [SerializeField] public Transform origin_offset;
